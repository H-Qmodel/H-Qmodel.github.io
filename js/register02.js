...
function checkEmail(email){
	...
	$.get('user.php?act=check_email',{email:email,rid:Math.random()},function(result){
		if(result == 'ok'){
			$("#tip_e_e").html('<img src="img/20161207190237.png" />');
...
function checkMobile(mobile){
    if (MobileRegCheck(mobile)) {
    	$.get('user.php?act=check_username',{username:mobile},function(data){
    		if(data == 'ok'){
    			$("#tip_m_m").html('<img src="img/20161207190237.png" />');
    		}else if(data == 'false'){
...
function check_password(password, divID) {
	...
	$("#"+divID).html('<img src="img/20161207190237.png" />');
	return true;
...
function checkEditPassword(){
	...
	if (password.length == 0) {
		...
		tip_gp_p.innerHTML = '<img src="img/20161207190237.png" />';
	}
}
...
function checkEditConfirmPassword(){
	...
	if (password.length == 0) {
		...
		tip_gp_cp.innerHTML = '<img src="img/20161207190237.png" />';
	}
}
